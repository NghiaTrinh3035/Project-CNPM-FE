...
export const reviews: Review[] = [
  {
    id: "r-001",
    customerId: "u-cus-001",
    productId: "p-004",
    rating: 5,
    comment: "Đồng hồ đẹp hơn ảnh, đeo lên tay rất sang và nhẹ. Máy chạy ổn định.",
  ...
  },
  {
    ...
    productId: "p-002",
    rating: 5,
    comment: "Chống nước tốt, hoàn thiện cao cấp, dịch vụ giao hàng chuyên nghiệp.",
    createdAt: "2026-01-12T15:20:00.000Z",
  },
  {
    id: "r-003",
    customerId: "u-cus-002",
    productId: "p-010",
    rating: 4,
    comment: "Thiết kế đẹp, mặt số dễ đọc. Dây da hơi cứng lúc mới đeo.",
